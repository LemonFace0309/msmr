      ...
      <div className="d-flex flex-column flex-md-row justify-content-center align-items-center">
        ...
        <div className="d-flex flex-column ml-5 py-2">
          ...
          <p>
            ...
            resilience capacity across different areas in your life.{' '}
          </p>
          <p>
            {' '}
            The MSMR digital application provides an opportunity for users to
            engage and learn about their personal resilience capacity - where
            they stand, and how they can improve their resilience.{' '}
          </p>
